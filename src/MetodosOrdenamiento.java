...
public class MetodosOrdenamiento {
    ...
    // Método de burbuja tradicional con errores
    // Error encontrado: no hay error solo se cambia el menor que por un mayor que para que imprima ascendente y no descendente
    ...
    // Método de selección con errores
    // Error encontrado: El arreglo en la posicion i hace que el intercambio no se haga en la ultima vuelta por eso se cambia por arreglo en la posion indiceMINimo 
    ...
    // Error encontrado: en bucle while debe tener mayor o igual que 0 y el menor que debe ser mayor que en arreglo [i]
